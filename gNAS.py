...
PDU_SESSION_RELEASE_REQUEST = 225
PDU_SESSION_RELEASE_REJECT = 226
PDU_SESSION_RELEASE_COMMAND = 227
PDU_SESSION_RELEASE_COMPLETE = 228
_5GSM_STATUS = 230
...
def nas_decode_5gs_sm_pdu_session_establishment_accept(ies):
    ...
    ies_list, pointer = return_ie_list_and_pointer(ies,ies_list,1,"TLV-E",IE_QOS_RULES)  
